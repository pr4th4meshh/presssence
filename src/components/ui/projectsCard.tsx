...
const Skeleton = () => {
  ...
  return (
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      ...
      <div className="h-40 w-px absolute top-20 m-auto z-10 bg-gradient-to-b from-transparent via-cyan-500 to-transparent animate-move">
...
export const CardTitle = ({
  ...
  return (
    <h3
      className={cn(
        "text-lg font-semibold text-gray-800 dark:text-white pt-6 pb-1",
        className
      )}
    >
      {children}
...
export const ProjectLink = ({ className, link }: { className?: string, link?: string }) => {
  return (
    <Link
      ...
      rel="noreferrer"
      className={cn(
        "dark:bg-white bg-black dark:text-black text-white py-4 w-full items-center justify-center rounded-md mt-4 flex text-sm",
        className
      )}
    >
...
// export const ProjectPreview = ({ children, className, link }: { children: React.ReactNode, className?: string, link?: string }) => {
//     return (
//       <Link
//         href={link}
//         target="_blank"
...
export const CardActions = ({ children, className }: { children: React.ReactNode, className?: string }) => {
  return (
