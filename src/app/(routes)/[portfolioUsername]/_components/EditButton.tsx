...
const EditButton = ({ onClick, className }: IEditButton) => {
  return (
    ...
    >
      ...
      <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-background text-foreground px-3 py-1 text-sm font-medium backdrop-blur-3xl">
