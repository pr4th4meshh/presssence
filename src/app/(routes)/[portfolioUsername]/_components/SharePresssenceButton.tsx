  ...
  return (
    <>
      ...
      <Button
        ...
        className="bg-green-600 text-white w-12 h-12 rounded-xl tracking-wide border-t-0 cursor-pointer hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-green-400"
