              ...
              <div className="bg-light dark:bg-dark rounded-2xl shadow-2xl border p-6 min-w-[400px] max-w-[500px]">
                ...
                >
                    ...
                    <div>
                      ...
                      {newSocialLink && (
                        ...
                        >
                          ...
                          {detectSocialPlatform(newSocialLink) ||
                            "Unknown platform"}
                        </motion.p>
                      )}
                    </div>
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <Button
                      type="submit"
                      className="flex-1 bg-dark text-white dark:bg-light dark:text-black"
                      disabled={isLoading}
                    >
                      {isLoading ? (
                        <motion.div
                        ...
                        `Add ${
                          dockItems.find((i) => i.type === addType)?.label
                        }`
                      )}
                    </Button>
                  </div>
        ...
        <motion.div className="bg-light dark:bg-dark rounded-2xl shadow-2xl border dark:border-white border-black p-2">
          <div className="flex items-center gap-2">
                  ...
                  className={`w-12 h-12 rounded-xl flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-200 group
                    ${
                      isActive
                        ...
                        : "bg-light dark:bg-dark text-black dark:text-white"
                    }`}
            ...
            {getIsOwner().isOwner && (
              <LogoutButton
                iconOnly
                className="w-12 h-12 rounded-xl bg-red-500 text-white border-none"
              />
            )}
          </div>
        </motion.div>
